import { attribute, beginBatch, mergePatch, endBatch, effect, getPath } from "https://cdn.jsdelivr.net/gh/starfederation/datastar@develop/bundles/datastar.js";
import { createDebounce, createRAFThrottle } from "./throttle.min.js";
...
function setupDragHandling(state, mergePatchFn, beginBatchFn2, endBatchFn2) {
...
function setupResponsiveHandling(state, config, mergePatchFn, beginBatchFn2, endBatchFn2) {
...
function detectAndCreateCornerHandles(effectFn, getPathFn, mergePatchFn) {
...
function createCornerHandle(h, v, hRect, vRect, effectFn, getPathFn, mergePatchFn) {
